...
INSERT INTO DW_SysExpert.dbo.Pedimento
	SELECT 
		...
		,PEDRECTIF.idRectificacion [idRectificacion]
		...
		,PDRECTIFDTA.Importe [RectificacionDiferenciaDTAImporte]
		...
		,PDRECTIFCC.Importe [RectificacionDiferenciaCCImporte]
		...
		,PDRECTIFIVA.Importe [RectificacionDiferenciaIVAImporte]
		...
		,PDRECTIFIEPS.Importe [RectificacionDiferenciaIEPSImporte]
		...
		,PDRECTIFIGIIGE.Importe [RectificacionDiferenciaIGI/IGEImporte]
		...
		,PDRECTIFREC.Importe [RectificacionDiferenciaRECImporte]
		...
		,PDRECTIFMULT.Importe [RectificacionDiferenciaMULTImporte]
		...
		,PDRECTIF303.Importe [RectificacionDiferencia303Importe]
		...
		,PDRECTIFRT.Importe [RectificacionDiferenciaRTImporte]
		...
		,PDRECTIFPRV.Importe [RectificacionDiferenciaPRVImporte]
		...
		,PDRECTIFEUR.Importe [RectificacionDiferenciaEURImporte]
		...
		,PDRECTIFECI.Importe [RectificacionDiferenciaECIImporte]
		...
		,PDRECTIFCNT.Importe [RectificacionDiferenciaCNTImporte]
		...
		,PDRECTIFIVAPRV.Importe [RectificacionDiferenciaIVA/PRVImporte]
		...
		,PEDGRALES.idMTEntrada [idMTEntrada]					
		...
		,PEDGRALES.idPrueba [idPrueba]							
		,PRUSUF.Clave [PruebaClave]
		,PRUSUF.Descripcion [PruebaDescripcion]
		,PEDGRALES.FechaPrueba [FechaPrueba]					
		,PEDGRALES.Anio [Anio]
		...
		,CLIDOM.Domicilio [ClienteDomicilioDomicilio]					
	...
	FROM Ped_Grales                            PEDGRALES
		...
		--Diferencias de contribuciones de ractificacion
		--DTA
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFDTA      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFDTA.idReferencia    AND PDRECTIFDTA.idContribucion = 1 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFDTAFP    WITH(NOLOCK) ON (PDRECTIFDTA.idFormaPago    = PDRECTIFDTAFP.idFormapago)
		--CC
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFCC       WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFCC.idReferencia     AND PDRECTIFCC.idContribucion = 2 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFCCFP     WITH(NOLOCK) ON (PDRECTIFCC.idFormaPago     = PDRECTIFCCFP.idFormapago)
		--IVA
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFIVA      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFIVA.idReferencia    AND PDRECTIFIVA.idContribucion = 3 AND  PDRECTIFDTA.Importe <> 0)
		...
		--IGIE
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFIGIIGE   WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFIGIIGE.idReferencia AND PDRECTIFIGIIGE.idContribucion = 6 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFIGIIGEFP WITH(NOLOCK) ON (PDRECTIFIGIIGE.idFormaPago = PDRECTIFIGIIGEFP.idFormapago)
		--REC
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFREC      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFREC.idReferencia    AND PDRECTIFREC.idContribucion = 7 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFRECFP    WITH(NOLOCK) ON (PDRECTIFREC.idFormaPago    = PDRECTIFRECFP.idFormapago)
		--MULT
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFMULT     WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFMULT.idReferencia   AND PDRECTIFMULT.idContribucion = 11 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFMULTFP   WITH(NOLOCK) ON (PDRECTIFMULT.idFormaPago   = PDRECTIFMULTFP.idFormapago)
		--303
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIF303      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIF303.idReferencia    AND PDRECTIF303.idContribucion = 12 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIF303FP    WITH(NOLOCK) ON (PDRECTIF303.idFormaPago    = PDRECTIF303FP.idFormapago)
		--RT
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFRT       WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFRT.idReferencia     AND (PDRECTIFRT.idContribucion = 13 OR PDRECTIFRT.idContribucion = 99 AND  PDRECTIFDTA.Importe <> 0))
		LEFT JOIN FormasDePago                 PDRECTIFRTFP     WITH(NOLOCK) ON (PDRECTIFRT.idFormaPago     = PDRECTIFRTFP.idFormapago)
		--PRV
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFPRV      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFPRV.idReferencia    AND PDRECTIFPRV.idContribucion = 15 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFPRVFP    WITH(NOLOCK) ON (PDRECTIFPRV.idFormaPago    = PDRECTIFPRVFP.idFormapago)
		--EUR
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFEUR      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFEUR.idReferencia    AND PDRECTIFEUR.idContribucion = 16 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFEURFP    WITH(NOLOCK) ON (PDRECTIFEUR.idFormaPago    = PDRECTIFEURFP.idFormapago)
		--ECI
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFECI      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFECI.idReferencia    AND PDRECTIFECI.idContribucion = 24 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFECIFP    WITH(NOLOCK) ON (PDRECTIFECI.idFormaPago    = PDRECTIFECIFP.idFormapago)
		--CNT
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFCNT      WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFCNT.idReferencia    AND PDRECTIFCNT.idContribucion = 73 AND  PDRECTIFDTA.Importe <> 0)
		LEFT JOIN FormasDePago                 PDRECTIFCNTFP    WITH(NOLOCK) ON (PDRECTIFCNT.idFormaPago    = PDRECTIFCNTFP.idFormapago)
		--IVAPRV
		LEFT JOIN Ped_DiferenciasRectificacion PDRECTIFIVAPRV   WITH(NOLOCK) ON (PEDGRALES.idReferencia     = PDRECTIFIVAPRV.idReferencia AND PDRECTIFIVAPRV.idContribucion = 79 AND  PDRECTIFDTA.Importe <> 0)
		...
		LEFT JOIN Ped_ContribucionesPedimento  PCPDTA			WITH(NOLOCK) ON (PEDGRALES.idReferencia = PCPDTA.idReferencia    AND PCPDTA.idContribucion = 1 AND  PDRECTIFDTA.Importe <> 0)
		...
		LEFT JOIN Ped_ContribucionesPedimento  PCPREC			WITH(NOLOCK) ON (PEDGRALES.idReferencia = PCPREC.idReferencia    AND PCPREC.idContribucion = 7 AND  PDRECTIFDTA.Importe <> 0)
